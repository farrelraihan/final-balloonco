...
// Initialize total profit variables
$total_profit_all_pages = 0;
$total_profit_current_page = 0;
...
// Calculate total profit across all pages
$total_profit_all_pages_query = "SELECT SUM(p.quantity * b.harga_beli) AS total_profit FROM penjualan p JOIN barang b ON p.id_barang = b.id_barang";
                                    ...
                                    <table class="table table-striped table-head-fixed text-nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            while ($data = mysqli_fetch_array($result)) {
                                                ...
                                                $total_profit_current_page += $profit;
                                                ?>
                                                <tr>
                                                    <td><?php echo $no; ?></td>
